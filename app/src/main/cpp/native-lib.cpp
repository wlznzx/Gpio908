...
Java_com_example_zerujus_c5demotest_SerialPort_open(JNIEnv *env, jclass thiz, jstring path,
...
Java_com_example_zerujus_c5demotest_SerialPort_close(JNIEnv *env, jobject thiz) {
